...
<form onSubmit={handleSubmit} className='space-y-6'>
    <div className='form-control'>
        ...
        <div className='relative'>
            ...
            <input type="text" className={`input input-border w-full pl-10`} placeholder='shiva' value={formdata.fullName} onChange={(e) => Setformdata({...formdata,fullName: e.target.value})} />
        </div>
    </div>
...
<div className='text-center'>
    ...
    <Link to="/login" className='link link-primmary'>
    Sign In
    </Link>
    </p>
</div>
